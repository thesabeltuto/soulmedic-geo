...
(function($) {	
	$(document).ready(function() {
		var breadcrumb = '<a href="<?=site_url()?>/">Home</a><span class="fa fa-angle-double-right">  </span><a href="<?=site_url()?>/team/">Team</a><span class="fa fa-angle-double-right">  </span><h1><?=$term?></h1>';
...
<?php $page_layout 	= dttheme_option('specialty','archives-layout');
	...
	endswitch;?>
      <!-- **Primary Section** -->
      <section id="primary" class="team <?php echo $page_layout;?>">

		<?php if(get_option('wm4d_page_team') != '' || get_option('wm4d_page_team') != null) { ?>
